"""
Loader for Yaleb handwritten digits dataset
"""

import numpy as np


def load_yaleb_images(data_path='./data/yaleb.npy', normalization='local'):
    
    
    print(f"Loading yaleb dataset from {data_path}...")
